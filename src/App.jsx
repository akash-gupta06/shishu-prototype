...
const TRANSLATIONS = {
  ...
  en: {
    ...
    govtSchemes: "Govt Schemes & Guidelines", milestone: "Milestone Tracker", reports: "Test Report Analyzer",
    dailyTips: "Daily Tips & Prompts", nutritionTip: "Nutrition Tip", schemeAlert: "Scheme Alert",
    emergency: "Emergency", legalPrivacy: "Legal & Privacy", chatTitle: "Ask/Talk Shishu",
    snapUnderstandAct: "1. Snap. 2. Understand. 3. Act.",
    uploadTip: "Click a clear photo of the symptom (rash, stool, etc.). Our VLM provides instant triage.",
    uploadImage: "Upload Symptom Image", runScan: "Run AI Health Scan", scanHistory: "View Smart Health Card History →",
    locationDetected: "Auto-detected Location: Bhilai, Chhattisgarh", nextVaccine: "Next Vaccine Due: DTaP (6 weeks)",
    nearbyCenters: "Nearby Centers & Slots", getDirections: "Get Directions",
    eligibilityCheck: "Personalized Eligibility Check",
    eligibleSchemes: "Based on your profile (Rural/Low-Income), you are eligible for the following major schemes:",
    eligible: "Eligible", viewBenefits: "View Detailed Benefits (Audio Explanation) →",
    chatPrompt: "Tap and speak your question in Hindi, Bengali, or English.",
    chatPrompt2: "Ask me about feeding, sleep, or schemes!", aiResponse: "AI Response (Voice-First Reply):",
